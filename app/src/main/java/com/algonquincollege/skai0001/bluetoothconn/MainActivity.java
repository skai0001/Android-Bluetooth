package com.algonquincollege.skai0001.bluetoothconn;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGreen.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                try {
                    mBTSocket.getOutputStream().write("2".toString().getBytes());
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
        ...
        btnBlue.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                try {
                    mBTSocket.getOutputStream().write("3".toString().getBytes());
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
